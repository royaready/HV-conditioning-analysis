...
% datafile = '2020-03-12-144554-hv-1.txt'; power_supply = 4;
...
[ramp_up_avg_discharge_times,ramp_up_avg_discharge_times_cutoff,...
    ...
    ramp_up_avg_time_length_of_chunk,ramp_up_avg_start_stop_times,...
    ramp_up_avg_num_not_optimized,...
    ramp_up_avg_gaus_avg,ramp_up_avg_gaus_stdev...
    ] = ...
    ...
    up_chunk_array,avg_binwidth,3,lcm1_avg_scale,2,discharge_cutoff,sprintf('means at %.0f kV chunk ',...
    vmon_avg_ramp_up_avg),...
    'neg_voltage_avg_steady_state',1,fullpath);
...
[ramp_up_avg_dph,ramp_up_avg_dph_std,ramp_up_median_discharge_size,...
    ...
    sprintf('means at %.0f kV ',vmon_avg_ramp_up_avg),...
    'neg_voltage_avg_discharges',0,fullpath);
...
[ramp_up_avg_discharge_times_sum,ramp_up_avg_discharge_times_sum_cutoff,...
    ...
    ramp_up_avg_time_length_of_chunk_sum,ramp_up_avg_start_stop_times_sum,...
    ramp_up_avg_sum_num_not_optimized,...
    ramp_up_avg_sum_gaus_avg,ramp_up_avg_sum_gaus_stdev...
    ] = ...
    find_discharges_final(lcm1_avg_ramp_up_raw,...
    lcm1_weight_avg_ramp_up_raw,time_ramp_up,lcm1_avg_ramp_up_avg,...
    lcm1_avg_ramp_up_total_stdev,1,...
    one_big_up_chunk_array,avg_binwidth,3,lcm1_avg_scale,2,discharge_cutoff,sprintf('means at %.0f kV chunk ',...
    vmon_avg_ramp_up_avg),...
    'neg_voltage_avg_steady_state_summed',1,fullpath);
...
[ramp_up_avg_dph_sum,ramp_up_avg_dph_std_sum,ramp_up_median_discharge_size_sum,...
    ...
    ramp_up_avg_time_length_of_chunk_sum,official_sim_start_time,official_sim_end_time,...
    sprintf('means at %.0f kV ',vmon_avg_ramp_up_avg),...
    'neg_voltage_avg_discharges_summed',0,fullpath);
...
[ramp_down_avg_discharge_times,ramp_down_avg_discharge_times_cutoff,...
    ...
    ramp_down_avg_time_length_of_chunk,ramp_down_avg_start_stop_times,...
    ramp_down_avg_num_not_optimized,...
    ramp_down_avg_gaus_avg,ramp_down_avg_gaus_stdev...
    ] = ...
    ...
    down_chunk_array,avg_binwidth,3,lcm1_avg_scale,2,discharge_cutoff,sprintf('means at %.0f kV chunk ',...
    vmon_avg_ramp_down_avg),...
    'pos_voltage_avg_steady_state',1,fullpath);
...
[ramp_down_avg_dph,ramp_down_avg_dph_std,ramp_down_median_discharge_size,...
    ...
    ramp_down_avg_time_length_of_chunk,official_sim_start_time,official_sim_end_time,...
    sprintf('means at %.0f kV ',vmon_avg_ramp_down_avg),...
    'pos_voltage_avg_discharges',0,fullpath);
...
[ramp_down_avg_discharge_times_sum,ramp_down_avg_discharge_times_sum_cutoff,...
    ...
    ramp_down_avg_time_length_of_chunk_sum,ramp_down_avg_start_stop_times_sum,...
    ramp_down_avg_sum_num_not_optimized,...
    ramp_down_avg_sum_gaus_avg,ramp_down_avg_sum_gaus_stdev...
    ] = ...
    find_discharges_final(lcm1_avg_ramp_down_raw,...
    lcm1_weight_avg_ramp_down_raw,time_ramp_down,lcm1_avg_ramp_down_avg,...
    lcm1_avg_ramp_down_total_stdev,1,...
    one_big_down_chunk_array,avg_binwidth,3,lcm1_avg_scale,2,discharge_cutoff,sprintf('means at %.0f kV chunk ',...
    vmon_avg_ramp_down_avg),...
    'pos_voltage_avg_steady_state_summed',1,fullpath);
...
[ramp_down_avg_dph_sum,ramp_down_avg_dph_std_sum,ramp_down_median_discharge_size_sum,...
    ...
    ramp_down_avg_time_length_of_chunk_sum,official_sim_start_time,official_sim_end_time,...
    sprintf('means at %.0f kV ',vmon_avg_ramp_down_avg),...
    'pos_voltage_avg_discharges_summed',0,fullpath);
...
[zero_avg_discharge_times,zero_avg_discharge_times_cutoff,...
    ...
    zero_avg_time_length_of_chunk,zero_avg_start_stop_times,...
    zero_avg_num_not_optimized,...
    ...
    zero_chunk_array,avg_binwidth,3,lcm1_avg_scale,2,discharge_cutoff,sprintf('means at %.0f kV chunk ',...
    vmon_avg_zero_avg),...
    'zero_voltage_avg_steady_state',1,fullpath);
...
[zero_avg_dph,zero_avg_dph_std,zero_avg_median_discharge_size,...
    ...
    zero_avg_time_length_of_chunk,official_sim_start_time,official_sim_end_time,...
    sprintf('means at %.0f kV ',vmon_avg_zero_avg),...
    'zero_voltage_avg_discharges',0,fullpath);
...
[zero_avg_discharge_times_sum,zero_avg_discharge_times_sum_cutoff,...
    ...
    zero_avg_time_length_of_chunk_sum,zero_avg_start_stop_times_sum,...
    zero_avg_sum_num_not_optimized,...
    zero_avg_sum_gaus_avg,zero_avg_sum_gaus_stdev...
    ] = ...
    find_discharges_final(lcm1_avg_zero_raw,...
    lcm1_weight_avg_zero_raw,zero_time,lcm1_avg_zero_avg,...
    lcm1_avg_zero_total_stdev,1,...
    one_big_zero_chunk_array,avg_binwidth,3,lcm1_avg_scale,2,discharge_cutoff,...
    sprintf('means at %.0f kV chunk ',vmon_avg_zero_avg),...
    'zero_voltage_avg_discharges_steady_state',1,fullpath);
...
[zero_avg_dph_sum,zero_avg_dph_std_sum,zero_avg_median_discharge_size_sum,...
    ...
    zero_avg_time_length_of_chunk_sum,official_sim_start_time,official_sim_end_time,...
    sprintf('means at %.0f kV ',vmon_avg_zero_avg),...
    'zero_voltage_avg_discharges_summed',0,fullpath);
...
[zero_stdev_discharge_times,zero_stdev_discharge_times_cutoff, zero_stdev_discharge_vals, ...
    ...
    zero_stdev_time_length_of_chunk,zero_stdev_start_stop_times,...
    zero_stdev_num_not_optimized,...
    zero_stdev_gaus_avg,zero_stdev_gaus_stdev...
    ] = ...
    ...
    vmon_avg_zero_avg),...
    'zero_voltage_stdev_steady_state',1,fullpath);
...
[zero_stdev_dph,zero_stdev_dph_std,zero_stdev_median_discharge_size,...
    ...
    sprintf('stdevs at %.0f kV ',vmon_avg_zero_avg),...
...
[zero_stdev_dph_cutoff,zero_stdev_dph_std_cutoff,zero_stdev_median_discharge_size_cutoff,...
    ...
    zero_stdev_time_length_of_chunk,official_sim_start_time,official_sim_end_time,...
    sprintf('stdevs at %.0f kV ',vmon_avg_zero_avg),...
    'zero_voltage_stdev_discharges_cutoff',0,fullpath);
...
[zero_stdev_discharge_times_sum,zero_stdev_discharge_times_sum_cutoff,...
    ...
    zero_stdev_time_length_of_chunk_sum,zero_stdev_start_stop_times_sum,...
    zero_stdev_sum_num_not_optimized,...
    zero_stdev_sum_gaus_avg,zero_stdev_sum_gaus_stdev...
    ] = ...
    find_discharges_final(lcm1_stdev_zero_raw,...
...
[zero_stdev_dph_sum_cutoff,zero_stdev_dph_std_sum_cutoff,...
    ...
    zero_stdev_time_length_of_chunk_sum,official_sim_start_time,official_sim_end_time,...
    sprintf('stdevs at %.0f kV ',vmon_avg_zero_avg),...
    'zero_voltage_stdev_discharges_summed_cutoff',0,fullpath);
...
[ramp_down_stdev_discharge_times,ramp_down_stdev_discharge_times_cutoff, ramp_down_stdev_discharge_vals, ...
    ...
    ramp_down_stdev_time_length_of_chunk,ramp_down_stdev_start_stop_times,...
    ramp_down_stdev_num_not_optimized,...
    ramp_down_stdev_gaus_avg,ramp_down_stdev_gaus_stdev...
    ] = ...
    ...
    vmon_avg_ramp_down_avg),...
    'pos_voltage_stdev_steady_state',1,fullpath);
...
[ramp_down_stdev_dph,ramp_down_stdev_dph_std,ramp_down_stdev_median_discharge_size,...
    ...
    sprintf('stdevs at %.0f kV ',vmon_avg_ramp_down_avg),...
...
[ramp_down_stdev_dph_cutoff,ramp_down_stdev_dph_std_cutoff,ramp_down_stdev_median_discharge_size_cutoff,...
    ...
    ramp_down_stdev_time_length_of_chunk,official_sim_start_time,official_sim_end_time,...
    sprintf('stdevs at %.0f kV ',vmon_avg_ramp_down_avg),...
    'pos_voltage_stdev_discharges_cutoff',0,fullpath);
...
[ramp_down_stdev_discharge_times_sum,ramp_down_stdev_discharge_times_sum_cutoff,...
    ...
    ramp_down_stdev_time_length_of_chunk_sum,ramp_down_stdev_start_stop_times_sum,...
    ramp_down_stdev_sum_num_not_optimized,...
    ramp_down_stdev_gaus_avg,ramp_down_stdev_gaus_stdev...
    ] = ...
    find_discharges_final(lcm1_avg_ramp_down_stdev_raw,...
...
[ramp_down_stdev_dph_sum_cutoff,ramp_down_stdev_dph_std_sum_cutoff,...
    ...
    ramp_down_stdev_time_length_of_chunk_sum,official_sim_start_time,official_sim_end_time,...
    sprintf('stdevs at %.0f kV ',vmon_avg_ramp_down_avg),...
    'pos_voltage_stdev_discharges_summed_cutoff',0,fullpath);
...
[ramp_up_stdev_discharge_times,ramp_up_stdev_discharge_times_cutoff,...
    ...
    ramp_up_stdev_time_length_of_chunk,ramp_up_stdev_start_stop_times,...
    ramp_up_stdev_num_not_optimized,...
    ramp_up_stdev_gaus_avg,ramp_up_stdev_gaus_stdev...
    ] = ...
    ...
    vmon_avg_ramp_up_avg),...
    'neg_voltage_stdev_steady_state',1,fullpath);
...
[ramp_up_stdev_dph,ramp_up_stdev_dph_std,ramp_up_stdev_median_discharge_size,...
    ...
    sprintf('stdevs at %.0f kV ',vmon_avg_ramp_up_avg),...
...
[ramp_up_stdev_dph_cutoff,ramp_up_stdev_dph_std_cutoff,ramp_up_stdev_median_discharge_size_cutoff,...
    ...
    ramp_up_stdev_time_length_of_chunk,official_sim_start_time,official_sim_end_time,...
    sprintf('stdevs at %.0f kV ',vmon_avg_ramp_up_avg),...
    'neg_voltage_stdev_discharges_cutoff',0,fullpath);
...
[ramp_up_stdev_discharge_times_sum,ramp_up_stdev_discharge_times_sum_cutoff,...
    ...
    ramp_up_stdev_time_length_of_chunk_sum,ramp_up_stdev_start_stop_times_sum,...
    ramp_up_stdev_sum_num_not_optimized,...
    ramp_up_stdev_sum_gaus_avg,ramp_up_stdev_sum_gaus_stdev...
    ] = ...
    find_discharges_final(lcm1_avg_ramp_up_stdev_raw,...
...
[ramp_up_stdev_dph_sum_cutoff,ramp_up_stdev_dph_std_sum_cutoff,...
    ...
    ramp_up_stdev_time_length_of_chunk_sum,official_sim_start_time,official_sim_end_time,...
    sprintf('stdevs at %.0f kV ',vmon_avg_ramp_up_avg),...
    'neg_voltage_stdev_discharges_summed_cutoff',0,fullpath);


%%%%%%%%%%%%%%%%%% calculate steady state leakage triplets %%%%%%%%%%%%%%%%

[ramp_down_triplet_avg,ramp_down_triplet_stdev,ramp_down_triplet_time]...
...
[ramp_down_steady_state_wt_avg,ramp_down_steady_state_wt_stdev] = ...
    wt_avg_stdev(ramp_down_triplet_avg,ramp_down_triplet_stdev);

[ramp_up_triplet_avg,ramp_up_triplet_stdev,ramp_up_triplet_time]...
    = triplet_calculator(ramp_up_avg_start_stop_times,zero_avg_start_stop_times,...
    ramp_up_avg_time_length_of_chunk,ramp_up_avg_gaus_avg,ramp_up_avg_gaus_stdev,...
    zero_avg_gaus_avg,zero_avg_gaus_stdev);

[ramp_up_steady_state_wt_avg,ramp_up_steady_state_wt_stdev] = ...
    wt_avg_stdev(ramp_up_triplet_avg,ramp_up_triplet_stdev);
...
legend_names = {sprintf('%.1f kV',vmon_avg_ramp_up_avg),...
    sprintf('%.1f kV',vmon_avg_ramp_down_avg),sprintf('%.1f kV',vmon_avg_zero_avg)};


hv_plot_xy_errors(sprintf('steady-state leakage current'),'time (min)','leakage current (pA)',...
    1,'',1,sprintf('%.1f kV',vmon_avg_zero_avg),[],...
    2,fullpath,'steady-state-leakage-vs-time-zero',[],...
    zero_avg_start_stop_times,zeros(1,length(zero_avg_start_stop_times(:,1))),...
    zero_avg_gaus_avg,zero_avg_gaus_stdev);

hv_plot_xy_errors(sprintf('steady-state leakage current'),'time (min)','leakage current (pA)',...
    1,'',1,sprintf('%.1f kV',vmon_avg_ramp_up_avg),[],...
    2,fullpath,'steady-state-leakage-vs-time-negative',[],...
    ramp_up_avg_start_stop_times(:,1),zeros(1,length(ramp_up_avg_start_stop_times(:,1))),...
    ramp_up_avg_gaus_avg,zeros(1,length(ramp_up_avg_gaus_avg)));

hv_plot_xy_errors(sprintf('steady-state leakage current'),'time (min)','leakage current (pA)',...
    1,'',1,sprintf('%.1f kV',vmon_avg_ramp_down_avg),[],...
    2,fullpath,'steady-state-leakage-vs-time-positive',[],...
    ramp_down_avg_start_stop_times(:,1),zeros(1,length(ramp_down_avg_start_stop_times)),...
    ramp_down_avg_gaus_avg,ramp_down_avg_gaus_stdev);

hv_plot_xy_errors(sprintf('steady-state leakage current'),'time (min)','leakage current (pA)',...
    1,'',1,{sprintf('%.1f kV',vmon_avg_ramp_down_avg),sprintf('%.1f kV',vmon_avg_zero_avg)},[],...
    2,fullpath,'steady-state-leakage-vs-time-positive-zero',[],...
    ramp_down_avg_start_stop_times(:,1),zeros(1,length(ramp_down_avg_start_stop_times)),...
    ramp_down_avg_gaus_avg,ramp_down_avg_gaus_stdev,...
    zero_avg_start_stop_times,zeros(1,length(zero_avg_start_stop_times(:,1))),...
    zero_avg_gaus_avg,zero_avg_gaus_stdev);
...
hv_plot_xy_errors(sprintf('steady-state leakage current'),'time (min)','leakage current (pA)',...
    1,'',1,{sprintf('%.1f kV',vmon_avg_ramp_up_avg),sprintf('%.1f kV',vmon_avg_zero_avg)},[],...
    2,fullpath,'steady-state-leakage-vs-time-negative-zero',[],...
    ramp_up_avg_start_stop_times(:,1),zeros(1,length(ramp_up_avg_start_stop_times(:,1))),...
    ramp_up_avg_gaus_avg,zeros(1,length(ramp_up_avg_gaus_avg)),...
    zero_avg_start_stop_times,zeros(1,length(zero_avg_start_stop_times(:,1))),...
    zero_avg_gaus_avg,zero_avg_gaus_stdev);
...
hv_plot_xy_errors(sprintf('steady-state leakage current'),'time (min)','triplet leakage current (pA)',...
    1,'',1,sprintf('%.1f kV',vmon_avg_ramp_up_avg),[],...
    2,fullpath,'triplet-leakage-vs-time-negative',[],...
    ramp_up_triplet_time,zeros(1,length(ramp_up_triplet_time)),...
    ramp_up_triplet_avg,ramp_up_triplet_stdev);

hv_plot_xy_errors(sprintf('steady-state leakage current'),'time (min)','triplet leakage current (pA)',...
    1,'',1,sprintf('%.1f kV',vmon_avg_ramp_down_avg),[],...
    2,fullpath,'triplet-leakage-vs-time-positive',[],...
    ramp_down_triplet_time,zeros(1,length(ramp_down_triplet_time)),...
    ramp_down_triplet_avg,ramp_down_triplet_stdev);

hv_plot_xy_errors(sprintf('steady-state leakage current'),'time (min)','leakage current (pA)',...
    1,'',1,legend_names(1:2),[],...
    2,fullpath,'steady-state-leakage-vs-time-all',[],...
    zero_avg_start_stop_times,zeros(1,length(zero_avg_start_stop_times(:,1))),...
    zero_avg_gaus_avg,zero_avg_gaus_stdev,...
    ramp_up_avg_start_stop_times(:,1),zeros(1,length(ramp_up_avg_start_stop_times(:,1))),...
    ramp_up_avg_gaus_avg,zeros(1,length(ramp_up_avg_gaus_avg)),...
...
hv_plot_xy_errors(sprintf('steady-state leakage current'),'time (min)','triplet leakage current (pA)',...
    1,'',1,legend_names(1:2),[],...
    2,fullpath,'steady-state-triplets-all',[],...
    ramp_up_triplet_time,zeros(1,length(ramp_up_triplet_time)),...
    ramp_up_triplet_avg,ramp_up_triplet_stdev,...
    ramp_down_triplet_time,zeros(1,length(ramp_down_triplet_time)),...
    ramp_down_triplet_avg,ramp_down_triplet_stdev);
...
fprintf(fileID,'offset-subtracted steady state leakage current: %.1f pA \n\n',ramp_up_steady_state_wt_avg);
...
for j = 1:length(ramp_down_stdev_dph)
    ...
    fprintf(fileID,'%f \t %f \t %f \t %f \t %f \t %f \t %f \t %f \t %f\n',...
        ramp_down_stdev_dph(j),... %1
        ramp_down_stdev_dph_std(j),... %2
        ramp_down_stdev_median_discharge_size(j),... %3
        ramp_down_stdev_dph_cutoff(j),...%4
        ramp_down_stdev_dph_std_cutoff(j),...%5
        ramp_down_stdev_median_discharge_size_cutoff(j),...%6
        vmon_avg_ramp_down_avg,... %7
        ramp_down_steady_state_wt_avg,... %8
        ramp_down_steady_state_wt_stdev); %9
